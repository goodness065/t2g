...
export default function FraudDetectionForm() {
  ...
  const mapToPCA = ({
    ...
    const isMediumRisk =
      international === 1 || timeofday === 2 || (online === 1 && amount > 500);
  ...
  const callVertexAIPredict = async (
    pcaVector: number[],
  ...
  return (
    <div>
          ...
          <div className="w-full bg-white">
            <div className="flex justify-between items-center py-6 px-4">
              <div className="flex items-center space-x-6">
                <Link
                  href="/"
                  className="group flex items-center space-x-3 text-gray-600 hover:text-purple-600 transition-colors"
                >
                ...
                <div className="flex items-center space-x-4">
                  <div className="relative p-3 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-600 rounded-2xl shadow-lg">
                    ...
                    {/* Added an icon to the gradient box */}
      ...
      {/* <Link
        href="/"
        className="group flex items-center space-x-3 text-gray-600 hover:text-blue-600 transition-colors"
      >
        <div className="p-2 bg-gray-100 group-hover:bg-blue-100 rounded-xl transition-colors">
          <ArrowLeft className="h-5 w-5" />
        </div>
            ...
            <div className="mt-8 text-center">
              <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
                ...
                <p className="text-blue-600 text-sm">
                  Processing your transaction data with AI...
                </p>
              </div>
            </div>
          ) : result ? (
