...
export default function Dashboard() {
  const features = [
    ...
    },
    {
      ...
      description: "AI-powered transaction fraud analysis using Vertex AI",
      icon: Shield,
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Access cutting-edge AI capabilities including image generation,
            video creation, audio synthesis, intelligent analysis, and
            personalized style assistance - all in one place.
          </p>
